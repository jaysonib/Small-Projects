//mind reader!!!!!
/*How to Play :   Take any two digit number,
		  add the two digits of the number,
		  subtract the sum from the original number,
		  see the symbol corresponding to the number u got
		  and press any key ,
		  the mind reader  displays the symbol.
